...
var loader = require('@test/ui-core/loader');
var tsc = require('@test/ui-core/dist/tsc');
...
var createForwardRef = function (ReactComponent, displayName) {
    var forwardRef = function (props, ref) {
        return React.createElement(ReactComponent, tslib.__assign({}, props, { forwardedRef: ref }));
    };
...
var createReactComponent = function (tagName) {
    ...
    var ReactComponent = /** @class */ (function (_super) {
        ...
        class_1.prototype.render = function () {
            var _a = this.props, children = _a.children, forwardedRef = _a.forwardedRef, style = _a.style, className = _a.className, cProps = tslib.__rest(_a, ["children", "forwardedRef", "style", "className", "ref"]);
            ...
            var newProps = tslib.__assign(tslib.__assign({}, propsToPass), { ref: forwardedRef, style: style,
                className: className });
